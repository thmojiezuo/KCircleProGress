...
-(void)buildLayout
{
    ...
    [gradientLayer setColors:[NSArray arrayWithObjects:(id)[_color CGColor],(id)[_color CGColor], nil]];
    ...
    //用于显示结束位置的小点
    _endPoint = [[UIView alloc] init];
    _endPoint.frame = CGRectMake(0, 0, 8.0,8.0);
    _endPoint.hidden = true;
    _endPoint.backgroundColor = [UIColor whiteColor];
    _endPoint.layer.borderColor = _color.CGColor;
    _endPoint.layer.borderWidth = 2;
    _endPoint.layer.cornerRadius = 4.0;
